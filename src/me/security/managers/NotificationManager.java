...
public class NotificationManager {
	...
	/**
	 * Trigger all NotificationSender in senders with values param
	 * Note: Multiple values will never send multiple notification on NotificationSender side.
	...
	public void triggerIFTTT(String... values) throws IllegalArgumentException {
		if(values.length == 0) throw new IllegalArgumentException("Cannot send no values in IFTTT");
		if(values.length > 3) throw new IllegalArgumentException("Cannot send more than 3 values in IFTTT");
